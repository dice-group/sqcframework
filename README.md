...
### Live Demo 
The SQCFramework live demo is available [here](http://akswnc9.informatik.uni-leipzig.de:8100/sqcframework/). However, currently it is down for an urgent server maintenance. Should be up soon. 
### Existing Benchmarks
